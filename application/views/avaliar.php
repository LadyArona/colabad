      ...
      <div class="card-header bg-white border-0">
        <ul class="nav nav-pills nav-fill flex-column flex-md-row" role="tablist">
          <li class="nav-item mr-2 mr-md-0">
            <a class="nav-link mb-sm-3 mb-md-0 active show" id="avaliar-tab" data-toggle="tab" href="#avaliar" role="tab" aria-controls="avaliar" aria-selected="true">
              <i class="ni ni-album-2"></i> Imagens Para Avaliar
            </a>
          </li>
          <li class="nav-item mr-2 mr-md-0">
            <a class="nav-link mb-sm-3 mb-md-0" id="cadastrar-tab" data-toggle="tab" href="#cadastrar" role="tab" aria-controls="cadastrar" aria-selected="false">
              <i class="fas fa-edit"></i> Fazer Avaliação
            </a>
          </li>
        </ul>
      </div>
      <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="avaliar" role="tabpanel" aria-labelledby="avaliar-tab">
          <div class="card-body">
            <div class="row">
              <div class="col-lg-12">
        ...
        <div class="tab-pane fade" id="cadastrar" role="tabpanel" aria-labelledby="cadastrar-tab">
          ...
          <form action="" method="POST" enctype="multipart/form-data" id="formProjeto">
            ...
            <h6 class="heading-small text-muted mb-4">DADOS DO AVALIAÇÃO</h6>
            <div class="pl-lg-4">
              <div class="row">
                <div class="col-md-12">
            ...
            <hr class="my-4" />
            <h6 class="heading-small text-muted mb-4">COLABORADORES DO AVALIAÇÃO</h6>
            <div class="pl-lg-4">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
